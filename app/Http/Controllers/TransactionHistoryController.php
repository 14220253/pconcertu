...
class TransactionHistoryController extends Controller
{
    ...
    public function index($customer_id)
    {
        $data = TicketOrderDetail::query()
            ...
            ->select('customers.name as customer_name', 'ticket_order_details.seat_id', 'tickets.price as price', 'master_events.name as event_name', 'ticket_order_details.ticket_id', 'ticket_types.name as name','events.poster as poster', 'events.id as event_id')
